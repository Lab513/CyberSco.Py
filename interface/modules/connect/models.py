...
try:
    ...
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///testssss.db'
    print('creating new DB in interface/modules/connect..')
    db = SQLAlchemy(app)
...
class User(UserMixin, db.Model):
    ...
    snap_addr = db.Column(db.String(100), index=False, unique=False, nullable=True)
